...
set_target_properties(GTest::gtest PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgtest.so.1.14.0"
  IMPORTED_SONAME_RELEASE "libgtest.so.1.14.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gtest )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gtest "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgtest.so.1.14.0" )
...
set_target_properties(GTest::gtest_main PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgtest_main.so.1.14.0"
  IMPORTED_SONAME_RELEASE "libgtest_main.so.1.14.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gtest_main )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gtest_main "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgtest_main.so.1.14.0" )
...
set_target_properties(GTest::gmock PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgmock.so.1.14.0"
  IMPORTED_SONAME_RELEASE "libgmock.so.1.14.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gmock )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gmock "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgmock.so.1.14.0" )
...
set_target_properties(GTest::gmock_main PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgmock_main.so.1.14.0"
  IMPORTED_SONAME_RELEASE "libgmock_main.so.1.14.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gmock_main )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gmock_main "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libgmock_main.so.1.14.0" )
